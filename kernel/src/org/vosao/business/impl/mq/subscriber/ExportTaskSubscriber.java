...
public class ExportTaskSubscriber extends AbstractSubscriber {
	...
	protected static final Log expLogger = LogFactory.getLog(ExportTaskSubscriber.class);
	...
	public void onMessage(Message message) {
		...
		try {
			 ...
			 * Full export 
			 * 
			 * msg.getExportType() = full
			 * msg.getCurrentFile() = null
			 * msg.getFileCounter() = 0
			 */
			expLogger.info("Export " + msg.getFilename() + " " + msg.getExportType() + " " 
			...
			expLogger.info("Export finished. " + zipOutStreamTaskAdapter
					.getFileCounter());
			...
			expLogger.info("Added new export task "
					+ zipOutStreamTaskAdapter.getCurrentFile());
		} catch (Exception e) {
			expLogger.error(e.toString() + " " + e.getMessage() + "\n"
