...
public class PagePermissionsFileFactory extends AbstractFileFactory {

	public PagePermissionsFileFactory(Business business) {
		super(business);
	}

	@Override
	public String getName() {
		return "_page_permissions.xml";
	}
	...
	public Resource getFile(String path) {
		...
		if (pages.size() > 0) {
			return new PagePermissionsFileResource(getBusiness(), pageURL);
		}
		return null;
	}
