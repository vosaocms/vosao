...
public class TagsFileResource extends AbstractFileResource {

	public TagsFileResource(Business aBusiness, String name) {
		super(aBusiness, name, new Date());
		setContentType("text/xml");
		setData(getBusiness().getImportExportBusiness()
				.getExporterFactory().getTagExporter().createXML());
	}
