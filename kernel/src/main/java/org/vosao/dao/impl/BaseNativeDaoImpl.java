...
public class BaseNativeDaoImpl<T extends BaseNativeEntity> 
		extends AbstractDaoImpl implements BaseNativeDao<T>{
	
	protected static final Log logger = LogFactory.getLog(
			BaseNativeDaoImpl.class);

	private Class clazz;
	private String kind;

	public BaseNativeDaoImpl(Class aClass) {
		clazz = aClass;
		kind = createKind();
	}
	
	public BaseNativeDaoImpl(Class aClass, String aKind) {
		clazz = aClass;
		kind = aKind;
	}
